...
export default function DarkLogin() {
	...
	return (
		<div className={`flex min-h-screen transition-colors duration-300 ${isDoom ? "bg-slate-950 text-slate-100" : "bg-slate-100 text-slate-900"
			}`}>
			{/* Sidebar links */}
			<Sidebar />
			...
			<div className="flex flex-1 flex-col">
				...
				{/* Login card */}
				<div className={`w-full max-w-md rounded-2xl mx-auto p-8 mt-10 shadow-xl transition-colors duration-300 ${isDoom ? "bg-slate-800" : "bg-white"
					}`}>
