...
import { Bookmark, Home as HomeIcon, Info, PlusCircle, User, Users } from "lucide-react";
import Link from "next/link";
import { usePathname } from "next/navigation";

type NavKey = "home" | "create" | "profile" | "posts" | "friends" | "info";
...
const NAV_ITEMS: Array<{
  ...
  hasNotification?: boolean;
    ...
    { key: 'posts', label: 'my-posts', icon: Bookmark, isReady: true, href: '/posts' },
